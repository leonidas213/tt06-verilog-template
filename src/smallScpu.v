...
module tt_um_smallscpu (
  ...
  assign s152 = s151[0];
  assign s153 = s151[1];
  assign s147 = (s152 & ~ s153);
  assign s149 = (~ s152 & s153);
  assign s12 = (s152 & s153);
  assign s28 = ~ s12;
  assign s30 = ~ s12;
  assign s32 = ~ s12;
  assign s39 = ~ s12;
  ...
  RegisterBlock RegisterBlock_i18 (
    .DataIn( s16 ),
    .WE( WE ),
    .clk( s12 ),
    .src( s9 ),
